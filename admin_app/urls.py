...
urlpatterns = [
    ...
    path('clients/read/<int:user_id>', views.aa_client_read, name='aa_client_read'),
    path('clients/update/<int:user_id>', views.aa_client_update, name='aa_client_update'),
    path('clients/delete/<int:user_id>', views.aa_client_delete, name='aa_client_delete'),
    path('clients/password/<int:user_id>', views.aa_client_update_pw, name='aa_client_pw_edit'),
    # Staff - CRUD
