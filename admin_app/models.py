...
class UserProfile(models.Model):
    ...
    business_name = models.CharField(max_length=45, blank=True, null=True)
    address_one = models.CharField(max_length=45, blank=True, null=True)
    address_two = models.CharField(max_length=45, blank=True, null=True)
    ...
    def __str__(self):
        return f"Proflie of {self.user.username}"
